  ...
  return (
    <section className="w-full bg-primary/50 py-12 sm:py-16 px-4 sm:px-6 lg:px-8 -mt-15">
      <div className="max-w-7xl mx-auto text-center sm:text-left">
        ...
        <p className="mt-2 mb-4 text-base sm:text-lg text-text">
          Search, view, and add new contacts easily.
        </p>

        <div className="flex flex-col sm:flex-row items-center gap-2 w-full max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 mt-8 md:mt-12 animate-slide-up">
          ...
          {!loading && (
            <div className="col-span-full flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
              <button
              ...
              >
                ...
                {list === 10 ? (
                  <FaChevronDown
                    className="opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 font-bold animate-pulse-glow"
                    size={16}
                  />
                ) : (
                  <FaChevronUp
              ...
              >
                Add new Contact
                <AiOutlinePlus
                  className="opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 font-bold"
                  size={24}
                />
              </button>
            </div>
